      ...
      _createClass(Tab2Page, [{
        ...
        value: function match() {
          ...
          for (var i = 0; i < this.name1.length; i++) {
            for (var j = 0; j < this.name2.length; j++) {
          ...
          var e = (this.name1.length + this.name2.length) / 2;
          this.n = this.c * 100 / e;
        }
      }]);
